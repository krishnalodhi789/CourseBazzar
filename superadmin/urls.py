...
from .views import course_offers,superadmin_wallet,logoutform, course_selling_history,index, loginform ,approved_course_list, not_approved_course_list, approved
urlpatterns = [
	path('',index, name='superadmin_index'),
	path('login/',loginform, name='superadmin_loginform'),
	path('logout/',logoutform, name='superadmin_logoutform'),
	...
	path('Superadmin/Wallet/',superadmin_wallet, name='superadmin_wallet'),
